...
<template>
  <div class="button-demo-stack">
    ...
    <p class="button-demo-text">当前状态：{{ isLoading ? '加载中' : '空闲' }}</p>
  </div>
</template>
...
<template>
  <div class="button-demo-stack">
    <div class="button-demo-row">
      <MyButton type="primary" :action="handleSubmit" @click="clickCount += 1"> 异步提交 </MyButton>
...
<template>
  <div class="button-demo-stack">
    ...
    <div class="button-demo-box button-demo-box--narrow">
      <MyButton ellipsis> 这是一段超长的按钮文本，超出容器宽度后会自动显示省略号 </MyButton>
    </div>
  </div>
</template>
